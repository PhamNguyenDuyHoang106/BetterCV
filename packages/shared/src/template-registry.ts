...
export const TEMPLATE_REGISTRY: TemplateRegistryEntry[] = [
  ...
  {
    id: "clarity-bold",
    name: "Rõ ràng (Clarity)",
    categoryCode: "BUSINESS",
    categoryName: "Business",
    tag: "Popular",
    atsScore: 94,
    filterCategory: "ATS Friendly",
    layoutLabel: "Clarity Bold",
    description:
      "Tiêu đề section dạng thanh đen tương phản cao, sidebar xám nhạt với ảnh chân dung — dễ quét và chuyên nghiệp.",
    industry: "Marketing, Content, Hành chính / General",
    styleBadge: "PROFESSIONAL",
    stageClass: "from-zinc-100 via-neutral-50 to-stone-200",
    accentBg: "bg-zinc-800",
    accentBgHover: "group-hover:bg-zinc-700",
  },
  {
    id: "rose-elegant",
    name: "Thanh nhã (Elegant)",
    categoryCode: "DESIGN",
    categoryName: "Design",
    tag: "Free",
    atsScore: 89,
    filterCategory: "Creative",
    layoutLabel: "Rose Elegant",
    description:
      "Tông hồng be ấm áp với điểm nhấn burgundy, hình tròn trang trí mờ — thanh lịch và nữ tính.",
    industry: "Sales, Kế toán, Nhân sự / Business",
    styleBadge: "CREATIVE",
    stageClass: "from-rose-50/60 via-stone-50 to-amber-50/40",
    accentBg: "bg-[#fce7f3]",
    accentBgHover: "group-hover:bg-[#fbcfe8]",
  },
  {
    id: "coral-impact",
    name: "Ấn tượng (Impact)",
    categoryCode: "BUSINESS",
    categoryName: "Business",
    tag: "Premium",
    atsScore: 87,
    filterCategory: "Business",
    layoutLabel: "Coral Impact",
    description:
      "Header nâu đậm full-width, ảnh tròn chồng lên header, kỹ năng dạng thanh tiến độ — mạnh mẽ và nổi bật.",
    industry: "Phiên dịch, Sales, Quản lý / Impressive",
    styleBadge: "EXECUTIVE",
    stageClass: "from-[#4a3728]/15 via-stone-50 to-amber-50/30",
    accentBg: "bg-[#78350f]/10",
    accentBgHover: "group-hover:bg-[#78350f]/20",
  },
  {
    id: "cobalt-flow",
    name: "Năng động (Flow)",
    ...
    atsScore: 92,
    filterCategory: "Student",
    layoutLabel: "Cobalt Flow",
    description:
      "Sidebar xanh cobalt bên phải, tiêu đề section có gạch ngang — trẻ trung, hiện đại cho sinh viên.",
    industry: "Sinh viên, Thực tập, Junior / Students",
    styleBadge: "MODERN",
    stageClass: "from-blue-50/50 via-sky-50 to-indigo-50/40",
    accentBg: "bg-[#dbeafe]",
    accentBgHover: "group-hover:bg-[#bfdbfe]",
  },
  {
    id: "navy-ambition",
    name: "Tham vọng (Ambition)",
    categoryCode: "BUSINESS",
    categoryName: "Business",
    tag: "Premium",
    atsScore: 90,
    filterCategory: "Business",
    layoutLabel: "Navy Ambition",
    description:
      "Sidebar navy đậm với accent vàng gold, typography sang trọng — dành cho ứng viên tham vọng cao.",
    industry: "Tài chính, Luật, Quản lý cấp trung / Executive track",
    styleBadge: "EXECUTIVE",
    stageClass: "from-slate-900/20 via-slate-50 to-amber-50/20",
    accentBg: "bg-[#1e293b]",
    accentBgHover: "group-hover:bg-[#334155]",
  },
  {
    id: "cyan-pro",
    name: "Tươi sáng (Cyan Pro)",
    categoryCode: "TECH",
    categoryName: "Tech",
    tag: "Popular",
    atsScore: 93,
    filterCategory: "Tech",
    layoutLabel: "Cyan Pro",
    description:
      "Khối header cyan nổi bật với ảnh vuông, bố cục hai cột cân đối — chuyên nghiệp và trẻ trung.",
    industry: "IT, Kỹ thuật, Vận hành / Tech & Ops",
    styleBadge: "MODERN",
    stageClass: "from-cyan-50 via-sky-50 to-teal-50/40",
    accentBg: "bg-[#06b6d4]",
    accentBgHover: "group-hover:bg-[#0891b2]",
  },
];
