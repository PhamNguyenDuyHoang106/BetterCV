...
const payload = {
  url: 'https://github.com/nguyenvu4354/MaterialSystem',
  locale: 'vi'
};

async function testGithubAnalyze() {
  console.log('Testing /api/ai/github/analyze...');
  const res = await fetch('http://localhost:4000/api/ai/github/analyze', {
    method: 'POST',
    headers: {
...
testGithubAnalyze().catch(console.error);
