      ...
      <div className="auth-card w-full max-w-md relative z-10 overflow-hidden">
        <div className="pt-9 pb-6 px-8 text-center border-b border-slate-100/90 bg-gradient-to-b from-white to-slate-50/50">
          <Link href="/" className="inline-block group">
            <div className="mx-auto w-14 h-14 bg-gradient-to-br from-primary via-primary-dark to-primary-darker rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-primary/30 group-hover:scale-[1.02] transition-transform">
              <span className="text-on-primary text-2xl font-bold tracking-tight">BC</span>
            </div>
          </Link>
